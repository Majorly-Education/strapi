...
// Note: For REST API dynamiczones, we still need __component for each item
      ...
      content: [
        {
          ...
          options: [
            ...
            {
              title: "To memorize industry statistics",
              isCorrect: false,
              order: 1,
            },
            {
              title: "To complete the course quickly",
              isCorrect: false,
              order: 2,
            },
            {
              title: "To collect certification points",
              isCorrect: false,
              order: 3,
            },
          ],
      ...
      content: [
        {
          ...
          correctAnswer: true,
          trueExplanation:
            "Both theory and practice are important, but practical application helps solidify learning.",
          falseExplanation:
            "Theory provides the foundation, but practice is essential for mastery.",
        },
      ],
    },
    {
